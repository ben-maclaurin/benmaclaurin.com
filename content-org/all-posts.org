...
#+begin_src lisp :tangle ~/.emacs.d/init.el
    ...
    (set-face-attribute 'default nil :font "Essential PragmataPro-18")
    (set-face-attribute 'fixed-pitch nil :font "Essential PragmataPro-18")
    (set-face-attribute 'variable-pitch nil :font "Essential PragmataPro-18")
...
#+begin_src lisp :tangle ~/.emacs.d/init.el
  ...
  (use-package ef-themes :config (load-theme 'ef-dark))
#+end_src
