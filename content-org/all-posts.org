...
#+begin_src lisp :tangle ~/.emacs.d/init.el
  ...
  (set-face-attribute 'default nil :font "Essential PragmataPro" :height 175)
  (set-face-attribute 'fixed-pitch nil :font "Essential PragmataPro" :height 175)
#+end_src
...
#+begin_src lisp :tangle ~/.emacs.d/init.el
  ...
  ;; (use-package ef-themes :config (load-theme 'modus-operandi))
#+end_src
